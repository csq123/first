...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            ...
            <a href="${pageContext.request.contextPath }/user/out.html">退出</a>
        </div>
    </header>
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/sys/bill/billlist.html">订单管理</a></li>
              ...
              <li><a href="${pageContext.request.contextPath }/user/out.html">退出系统</a></li>
             </ul>
         </nav>
     </div>
