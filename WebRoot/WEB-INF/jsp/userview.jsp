...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>证件照：</strong><span><img src="${pageContext.request.contextPath}${user.totalpath}"></span></p>
            <p><strong>工作证照：</strong><span><img src="${pageContext.request.contextPath}${user.totalpaths}"></span></p>
